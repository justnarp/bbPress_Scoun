...
<head>
	...
	<link rel="icon" href="<?php bb_option('uri'); ?>bb-templates/scoun/images/favicon.ico" />
...
<div id="wrapper">
<?php login_form(); ?>
<div id="header"><a href="<?php bb_option('uri'); ?>"><img src="<?php bb_option('uri'); ?>bb-templates/scoun/images/header.jpg" alt="<?php bb_option('name'); ?>" /></a></div>
